...
#define PIN_DMD_nOE       PB0//PB7//PB10//PA1//9    // D9 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high frequency for brightness control.
#define PIN_DMD_A         PA10//PB1//PB11//PA2//6    // D6
#define PIN_DMD_B         PA9//PB10//PB8//PA3//7    // D7
#define PIN_DMD_CLK       PB13//PA5//13   // D13_SCK  is SPI Clock if SPI is used
#define PIN_DMD_SCLK      PA8//PB11//PB9//PA6//8    // D8
#define PIN_DMD_R_DATA    PB15//PA7//11   // D11_MOSI is SPI Master Out if SPI is used
...
//#define PIN_OTHER_SPI_nCS PA4//10
...
class DMD
{
  public:
	...
	//DMD(byte panelsWide, byte panelsHigh, SPIClass SPI2);
	//virtual ~DMD();
  ...
  void scanDisplayBySPI(SPIClass SPI_2);
